...
CREATE SEQUENCE IF NOT EXISTS creators_id_sequence;
ALTER TABLE creators ALTER creator_id SET DEFAULT NEXTVAL('creators_id_sequence');

CREATE SEQUENCE IF NOT EXISTS descriptions_id_sequence;
ALTER TABLE descriptions ALTER description_id SET DEFAULT NEXTVAL('descriptions_id_sequence');

CREATE SEQUENCE IF NOT EXISTS domain_metadata_id_sequence;
ALTER TABLE domain_metadata ALTER metadata_id SET DEFAULT NEXTVAL('domain_metadata_id_sequence');

CREATE SEQUENCE IF NOT EXISTS domain_schema_id_sequence;
ALTER TABLE domain_schemas ALTER schema_id SET DEFAULT NEXTVAL('domain_schema_id_sequence');

CREATE SEQUENCE IF NOT EXISTS geospatial_id_sequence;
ALTER TABLE geospatial ALTER geospatial_id SET DEFAULT NEXTVAL('geospatial_id_sequence');

CREATE SEQUENCE IF NOT EXISTS records_id_sequence;
ALTER TABLE records ALTER record_id SET DEFAULT NEXTVAL('records_id_sequence');

CREATE SEQUENCE IF NOT EXISTS repositories_id_sequence;
ALTER TABLE repositories ALTER repository_id SET DEFAULT NEXTVAL('repositories_id_sequence');

CREATE SEQUENCE IF NOT EXISTS publishers_id_sequence;
ALTER TABLE publishers ALTER publisher_id SET DEFAULT NEXTVAL('publishers_id_sequence');

CREATE SEQUENCE IF NOT EXISTS rights_id_sequence;
ALTER TABLE rights ALTER rights_id SET DEFAULT NEXTVAL('rights_id_sequence');

CREATE SEQUENCE IF NOT EXISTS subjects_id_sequence;
ALTER TABLE subjects ALTER subject_id SET DEFAULT NEXTVAL('subjects_id_sequence');

CREATE SEQUENCE IF NOT EXISTS tags_id_sequence;
ALTER TABLE tags ALTER tag_id SET DEFAULT NEXTVAL('tags_id_sequence');

CREATE SEQUENCE IF NOT EXISTS settings_id_sequence;
ALTER TABLE settings ALTER setting_id SET DEFAULT NEXTVAL('settings_id_sequence');

CREATE SEQUENCE IF NOT EXISTS access_id_sequence;
